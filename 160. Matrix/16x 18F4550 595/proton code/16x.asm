...
F2_EOF equ $ ; ABRAR
F1_SOF equ $ ; ABRAR
F1_000013 equ $ ; IN [ABRAR] TRISA = 0 : TRISB = 0 : TRISC = 0 : TRISD = 0
        clrf TRISA,0
        clrf TRISB,0
        clrf TRISC,0
        clrf TRISD,0
F1_000014 equ $ ; IN [ABRAR] ALL_DIGITAL = 1
        movlw 7
        movwf CMCON,0
        movlw 15
        movwf ADCON1,0
main
F1_000029 equ $ ; IN [ABRAR] FOR SCROLL = 0 TO 192 STEP 2
        clrf scrollH,0
        clrf scroll,0
FR@LB2
        movf scrollH,F,0
        ...
        btfsc STATUS,0,0
        go@to NX@LB3
F1_000030 equ $ ; IN [ABRAR] FOR SCAN = 0 TO 5
        clrf scan,0
FR@LB5
        movlw 6
        subwf scan,W,0
        btfsc STATUS,0,0
        go@to NX@LB6
F1_000031 equ $ ; IN [ABRAR] DTA = 1 : CLK = 1 : CLK = 0 : STB = 1 : STB = 0
        bsf PORTC,0,0
        bsf PORTC,1,0
        bcf PORTC,1,0
        bsf PORTC,2,0
        bcf PORTC,2,0
F1_000032 equ $ ; IN [ABRAR] DCH = 0
        clrf dchH,0
        clrf dch,0
F1_000033 equ $ ; IN [ABRAR] FOR COL = 0 TO 31
        clrf col,0
FR@LB8
        movlw 32
        subwf col,W,0
        btfsc STATUS,0,0
        go@to NX@LB9
F1_000034 equ $ ; IN [ABRAR] ROW1 =~ CREAD DTA1 + DCH + SCROLL
        movlw ((dta1 >> 8) & 255)
        movwf PBP#VAR0H,0
        movlw (dta1 & 255)
        movwf PBP#VAR0,0
        ...
        movff TABLAT,PORTB
        comf PORTB,F,0
F1_000035 equ $ ; IN [ABRAR] DCH = DCH + 1
        infsnz dch,F,0
        incf dchH,F,0
F1_000036 equ $ ; IN [ABRAR] ROW2 =~ CREAD DTA1 + DCH + SCROLL
        movlw ((dta1 >> 8) & 255)
        movwf PBP#VAR0H,0
        movlw (dta1 & 255)
        movwf PBP#VAR0,0
        ...
        movff TABLAT,PORTD
        comf PORTD,F,0
F1_000037 equ $ ; IN [ABRAR] DCH = DCH + 1
        infsnz dch,F,0
        incf dchH,F,0
F1_000038 equ $ ; IN [ABRAR] DELAYUS 500
        movlw 1
        movwf PP0H,0
        movlw 244
        f@call DLUS@W
F1_000039 equ $ ; IN [ABRAR] DTA = 0 : CLK = 1 : CLK = 0 : STB = 1 : STB = 0
        bcf PORTC,0,0
        bsf PORTC,1,0
        bcf PORTC,1,0
        bsf PORTC,2,0
        bcf PORTC,2,0
CT@LB10
F1_000040 equ $ ; IN [ABRAR] NEXT COL
        incf col,F,0
        btfss STATUS,0,0
        go@to FR@LB8
NX@LB9
CT@LB7
F1_000041 equ $ ; IN [ABRAR] NEXT SCAN
        incf scan,F,0
        btfss STATUS,0,0
        go@to FR@LB5
NX@LB6
CT@LB4
F1_000042 equ $ ; IN [ABRAR] NEXT SCROLL
        movlw 2
        addwf scroll,F,0
        movlw 0
        addwfc scrollH,F,0
        ...
        go@to FR@LB2
NX@LB3
F1_000043 equ $ ; IN [ABRAR] GOTO MAIN
        F@JUMP main
dta1
        db 0,0,0,0,0,0
        db 0,0,0,0,0,0
        ...
        db 0,0,0,0,0,0
        db 0,0,0,0
        db 8,0,233,30,169,18
        db 169,18,169,18,41,18
        db 41,18,41,18
        db 41,18,41,18,41,18
        db 239,19,8,0,232,7
        db 24,8,8,16
        db 8,0,136,7,72,8
        db 72,16,136,0,8,3
