#line 1 "C:/Users/antor/Google Drive/Embedded Projects/Salim Bhai/1. 5 alarm clock/Firmware/alarm5.c"
...
void setup_time(){
 ...
 Lcd_Chr(1,8,'H');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm1_hh++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'M');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm1_mm++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'S');
 while(! RB0_bit ){
 if( RB1_bit ) {flag_1 =~ flag_1; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'H');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm2_hh++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'M');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm2_mm++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'S');
 while(! RB0_bit ){
 if( RB1_bit ) {flag_2 =~ flag_2; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'H');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm3_hh++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'M');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm3_mm++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'S');
 while(! RB0_bit ){
 if( RB1_bit ) {flag_3 =~ flag_3; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'H');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm4_hh++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'M');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm4_mm++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'S');
 while(! RB0_bit ){
 if( RB1_bit ) {flag_4 =~ flag_4; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'H');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm5_hh++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'M');
 while(! RB0_bit ){
 if( RB1_bit ) {alarm5_mm++; delay_ms(500);}
 ...
 Lcd_Chr(1,8,'S');
 while(! RB0_bit ){
 if( RB1_bit ) {flag_5 =~ flag_5; delay_ms(500);}
