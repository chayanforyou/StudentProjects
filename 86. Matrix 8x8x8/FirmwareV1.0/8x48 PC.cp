#line 1 "C:/Users/antor/Google Drive/Embedded Projects/Aminul Sir/7. Matrix 8x8x8/FirmwareV1.0/8x48 PC.c"
#line 1 "c:/users/antor/google drive/embedded projects/aminul sir/7. matrix 8x8x8/firmwarev1.0/font.h"
...
#line 18 "C:/Users/antor/Google Drive/Embedded Projects/Aminul Sir/7. Matrix 8x8x8/FirmwareV1.0/8x48 PC.c"
int scroll;
int adress;
int count;
int update;
...
#line 56 "C:/Users/antor/Google Drive/Embedded Projects/Aminul Sir/7. Matrix 8x8x8/FirmwareV1.0/8x48 PC.c"
void load_text(){
 char x = 0;
 char read;
...
void main() {
 ...
 I2C1_Init(100000);
 delay_ms(1000);
 for(count = 0; count <  64 ; count++) buffer[count] = 0;
 ...
 for(update = 0; update <  64 ; update++){buffer[update] = buffer[update + 1];}
 buffer[ 64  - 1] = Character[count];
