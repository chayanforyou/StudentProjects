#line 1 "C:/Users/antor/Google Drive/Embedded Projects/Rifat Bhai/Motor controller auto ON-OFF/firmwareC/pumpMotor.c"
#line 14 "C:/Users/antor/Google Drive/Embedded Projects/Rifat Bhai/Motor controller auto ON-OFF/firmwareC/pumpMotor.c"
...
void segmentOut(char d, char val){
 mask(val);
 switch(d){
 case 1:  RC5_bit  = 0; break;
 case 2:  RC1_bit  = 0; break;
 case 3:  RC2_bit  = 0; break;
 case 4:  RC6_bit  = 0; break;
 case 5:  RC7_bit  = 0; break;
 }
 delay_ms(1);
 clearDigit();
}
...
void main() {
 ...
 soft_I2C_init();
 InitTimer1();
#line 244 "C:/Users/antor/Google Drive/Embedded Projects/Rifat Bhai/Motor controller auto ON-OFF/firmwareC/pumpMotor.c"
 ...
 if( RA0_bit ) {while( RA0_bit ); setupTime();}
 if( RA3_bit ) motorFlag = 1;
 currentMM = targetMM;
 currentSS = targetSS;
 }
 }
