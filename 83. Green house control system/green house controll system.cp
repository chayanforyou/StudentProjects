#line 1 "D:/1. Electronics/Antor's corner/Aminul Sir/4. Green house control system/green house controll system.c"
...
void main(){
 ...
 Get_Temperature();
 delay_ms(500);
 if(humidity < Humidity_on) { RC1_bit  = 1;}
 if(temperature < Temperature_on) { RC2_bit  = 1;}
 if(soil < soil_on) { RC3_bit  = 1;}
 if(humidity > Humidity_off) { RC1_bit  = 0;}
 if(temperature > Temperature_off) { RC2_bit  = 0;}
 if(soil > soil_off) { RC3_bit  = 0;}
 }
 }
